                ...
                @for ($i = 1; $i <= 12; $i++)
                    <article class="product-card">
                        ...
                        <div class="product-info">
                            <h3 class="product-name">Contra Filé 500g - R$29,99</h3>
                            ...
                            <a href="produtos/detalhe" class="btn btn-primary add-to-cart"
                                data-product="Contra Filé 500g - R$29,99" data-image="churrasco-10.png">ADICIONAR AO
                                CARRINHO</a href="#">
                        </div>
                    </article>
                @endfor
